...
namespace Zertz.Rendering {
	...
	public class PopupBook : IRenderable, ILoadable, ITimeSensitive {
		...
		public void OnLoad (EventArgs e) {
			...
			this.glTa = new Texture(Assembly.GetExecutingAssembly().GetManifestResourceStream("Zertz.resources.popbook_bg.jpg")).GenerateOpenGLBuffer();
			this.glTb = new Texture(Assembly.GetExecutingAssembly().GetManifestResourceStream("Zertz.resources.gods.png")).GenerateOpenGLBuffer();
			this.glB = new Texture(Assembly.GetExecutingAssembly().GetManifestResourceStream("Zertz.resources.book.jpg")).GenerateOpenGLBuffer();
			//pbri.OnLoad(e);
		}
