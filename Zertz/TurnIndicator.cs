...
namespace Zertz.Rendering {
	...
	public class TurnIndicator : SizableBase, IRenderable, ITimeSensitive, ILoadable {
		...
		public void Render (OpenTK.FrameEventArgs e) {
			...
			GL.TexCoord2(f1_12, 0.0f);
			GL.Vertex2(0.5f*this.Height, 0.0f);
			GL.TexCoord2(f1_12, 0.5f);
			GL.Vertex2(0.5f*this.Height, this.Height);
			...
			GL.Vertex2(this.innerWidth*0.5f-1.5f*this.Height, 0.0f);
			GL.TexCoord2(0.25f, 0.5f);
			GL.Vertex2(this.innerWidth*0.5f-1.5f*this.Height, this.Height);
			GL.TexCoord2(f1_12, 0.5f);
			GL.Vertex2(0.5f*this.Height, this.Height);
			//body
			GL.TexCoord2(0.25f, 0.0f);
			...
			GL.Vertex2(this.innerWidth*0.5f, 0.0f);
			GL.TexCoord2(0.5f, 0.5f);
			GL.Vertex2(this.innerWidth*0.5f, this.Height);
			GL.TexCoord2(0.25f, 0.5f);
			GL.Vertex2(this.innerWidth*0.5f-1.5f*this.Height, this.Height);
			//LEFT TURQUOISE
			...
			//right wing
			GL.TexCoord2(1.0f-f1_12, 0.0f);
			GL.Vertex2(this.innerWidth-0.5f*this.Height, 0.0f);
			GL.TexCoord2(0.75f, 0.0f);
			GL.Vertex2(this.innerWidth*0.5f+1.5f*this.Height, 0.0f);
			GL.TexCoord2(0.75f, 0.5f);
			GL.Vertex2(this.innerWidth*0.5f+1.5f*this.Height, this.Height);
			GL.TexCoord2(1.0f-f1_12, 0.5f);
			GL.Vertex2(this.innerWidth-0.5f*this.Height, this.Height);
			//right cartouche
			GL.TexCoord2(1.0f, 0.0f);
			GL.Vertex2(this.innerWidth, 0.0f);
			GL.TexCoord2(1.0f-f1_12, 0.0f);
			GL.Vertex2(this.innerWidth-0.5f*this.Height, 0.0f);
			GL.TexCoord2(1.0f-f1_12, 0.5f);
			GL.Vertex2(this.innerWidth-0.5f*this.Height, this.Height);
			GL.TexCoord2(1.0f, 0.5f);
			GL.Vertex2(this.innerWidth, this.Height);
			//body
			GL.TexCoord2(0.5f, 0.0f);
			GL.Vertex2(this.innerWidth*0.5f, 0.0f);
			GL.TexCoord2(0.75f, 0.0f);
