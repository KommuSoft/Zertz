...
namespace Zertz.Rendering.Zertz {
	...
	public class ZertzCupRenderer : IRenderable, ILoadable, ITimeSensitive {
		...
		public void OnLoad (EventArgs e) {
			...
			/*this.glBuff = MeshBuilder.GenerateHeightMap(new Texture(Assembly.GetExecutingAssembly().GetManifestResourceStream("Zertz.resources.EarthElevation_2048x1024.jpg")),HALF_WIDTH/1024.0f,0.25f,0x02,out this.glIdBuff, out this.glN);
			this.glT = new Texture(Assembly.GetExecutingAssembly().GetManifestResourceStream("Zertz.resources.EarthMap_2048x1024.jpg")).GenerateOpenGLBuffer();//*/
			ws.OnLoad(e);
		}
