...
namespace Zertz.Rendering {
	...
	public class StateIndicator : SizableBase, ILoadable, IRenderable {
		...
		public void Render (OpenTK.FrameEventArgs e) {
			...
			GL.TexCoord2(f1_4, 0.0f);
			GL.Vertex2(64.0f, 0.0f);
			GL.TexCoord2(f1_4, f1_4);
			GL.Vertex2(64.0f, 64.0f);
			GL.TexCoord2(0.0f, f1_4);
			GL.Vertex2(0.0f, 64.0f);
			
			GL.TexCoord2(f1_4, 0.0f);
			GL.Vertex2(64.0f, 0.0f);
			GL.TexCoord2(f1_2, 0.0f);
			GL.Vertex2(this.Width-64.0f, 0.0f);
			GL.TexCoord2(f1_2, f1_4);
			GL.Vertex2(this.Width-64.0f, 64.0f);
			GL.TexCoord2(f1_4, f1_4);
			GL.Vertex2(64.0f, 64.0f);
			
			GL.TexCoord2(f1_2, 0.0f);
			GL.Vertex2(this.Width-64.0f, 0.0f);
			GL.TexCoord2(f3_4, 0.0f);
			GL.Vertex2(this.Width, 0.0f);
			GL.TexCoord2(f3_4, f1_4);
			GL.Vertex2(this.Width, 64.0f);
			GL.TexCoord2(f1_2, f1_4);
			GL.Vertex2(this.Width-64.0f, 64.0f);
			...
			GL.TexCoord2(f1_4, f1_4);
			GL.Vertex2(64.0f, 64.0f);
			GL.TexCoord2(f1_4, f1_2);
			GL.Vertex2(64.0f, this.Height);
			GL.TexCoord2(0.0f, f1_2);
			GL.Vertex2(0.0f, this.Height);
			
			GL.TexCoord2(f1_4, f1_4);
			GL.Vertex2(64.0f, 64.0f);
			GL.TexCoord2(f1_2, f1_4);
			GL.Vertex2(this.Width-64.0f, 64.0f);
			GL.TexCoord2(f1_2, f1_2);
			GL.Vertex2(this.Width-64.0f, this.Height);
			GL.TexCoord2(f1_4, f1_2);
			GL.Vertex2(64.0f, this.Height);
			...
			for(int i = 0x00; i < this.CurrentState; i++) {
				...
				GL.Begin(BeginMode.Quads);
				GL.TexCoord2(0.0f, f3_4);
				GL.Vertex2(-this.rRadio, -this.rRadio);
				GL.TexCoord2(f1_4, f3_4);
				GL.Vertex2(this.rRadio, -this.rRadio);
				GL.TexCoord2(f1_4, 1.0f);
				GL.Vertex2(this.rRadio, this.rRadio);
			...
			if(this.currentState >= 0x00) {
				...
				GL.TexCoord2(f1_4, f3_4);
				GL.Vertex2(-this.rRadio, -this.rRadio);
				GL.TexCoord2(f1_2, f3_4);
				GL.Vertex2(this.rRadio, -this.rRadio);
				GL.TexCoord2(f1_2, 1.0f);
				GL.Vertex2(this.rRadio, this.rRadio);
				GL.TexCoord2(f1_4, 1.0f);
				GL.Vertex2(-this.rRadio, this.rRadio);
			}
			...
			GL.Vertex2(vx1, vy0);
			GL.TexCoord2(x1, y1);
			GL.Vertex2(vx1, this.Height);
			GL.TexCoord2(x0, y1);
			GL.Vertex2(vx0, this.Height);
			GL.End();
