	...
	public static class MeshBuilder {//general structure: X3,N3,T2
		...
		public static int BuildPopupPolygon (PointF[] polygon) {
			...
			for(int k = 0x00; k < n; k++) {
				...
				xnt[i++] = px-0.5f;	xnt[i++] = 1.0f-py;	xnt[i++] = d;//X'0
				xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
				xnt[i++] = px;		xnt[i++] = py;//T
		...
		public static int BuildPopupRectangle () {
			...
			int i = 0x00;
			xnt[i++] = -0.5f;	xnt[i++] = 0.0f;	xnt[i++] = -d;//X'0
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//T
			xnt[i++] = -0.5f;	xnt[i++] = 1.0f;	xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			xnt[i++] = 0.5f;	xnt[i++] = 1.0f;	xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//T
			xnt[i++] = 0.5f;	xnt[i++] = 0.0f;	xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = 1.0f;	xnt[i++] = 1.0f;
			
			xnt[i++] = 0.5f;	xnt[i++] = 0.0f;	xnt[i++] = d;//X'1
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = 1.0f;	xnt[i++] = 1.0f;//T
			xnt[i++] = 0.5f;	xnt[i++] = 1.0f;	xnt[i++] = d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//T
			xnt[i++] = -0.5f;	xnt[i++] = 1.0f;	xnt[i++] = d;//X
		...
		public static int BuildCuboid (float w, float h, float d) {
			...
			int i = 0x00;
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -d;//X'0
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx0;		xnt[i++] = ty1;//T
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//X
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx0;		xnt[i++] = ty0;//T
			xnt[i++] = w;		xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//X
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = ty0;//T
			xnt[i++] = w;		xnt[i++] = 0.0f;	xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = ty1;
			
			xnt[i++] = w;		xnt[i++] = -h;		xnt[i++] = -d;//X'1
			xnt[i++] = 0.0f;	xnt[i++] = -1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx2;		xnt[i++] = ty1;//T
			xnt[i++] = w;		xnt[i++] = -h;		xnt[i++] = 0.0f;//X
			xnt[i++] = 0.0f;	xnt[i++] = -1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx2;		xnt[i++] = ty0;//T
			xnt[i++] = 0.0f;	xnt[i++] = -h;		xnt[i++] = 0.0f;//X
			xnt[i++] = 0.0f;	xnt[i++] = -1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx1;		xnt[i++] = ty0;//T
			xnt[i++] = 0.0f;	xnt[i++] = -h;		xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = -1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx1;		xnt[i++] = ty1;
			
			xnt[i++] = 0.0f;	xnt[i++] = -h;		xnt[i++] = -d;//X'2
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = tx1;		xnt[i++] = ty1;//T
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = tx1;		xnt[i++] = 1.0f;//T
			xnt[i++] = w;		xnt[i++] = 0.0f;	xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = tx2;		xnt[i++] = 1.0f;//T
			xnt[i++] = w;		xnt[i++] = -h;		xnt[i++] = -d;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = tx2;		xnt[i++] = ty1;
			
			xnt[i++] = w;		xnt[i++] = -h;		xnt[i++] = 0.0f;//X'3
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = tx2;		xnt[i++] = ty0;//T
			xnt[i++] = w;		xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = tx2;		xnt[i++] = 0.0f;//T
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = tx1;		xnt[i++] = 0.0f;//T
			xnt[i++] = 0.0f;	xnt[i++] = -h;		xnt[i++] = 0.0f;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = tx1;		xnt[i++] = ty0;
			
			xnt[i++] = 0.0f;	xnt[i++] = -h;		xnt[i++] = 0.0f;//X'3
			xnt[i++] = -1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx1;		xnt[i++] = ty0;//T
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//X
			xnt[i++] = -1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx0;		xnt[i++] = ty0;//T
			...
			xnt[i++] = w;		xnt[i++] = -h;		xnt[i++] = -d;//X'3
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx2;		xnt[i++] = ty1;//T
			xnt[i++] = w;		xnt[i++] = 0.0f;	xnt[i++] = -d;//X
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 1.0f;	xnt[i++] = ty1;//T
			xnt[i++] = w;		xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//X
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 1.0f;	xnt[i++] = ty0;//T
			xnt[i++] = w;		xnt[i++] = -h;		xnt[i++] = 0.0f;//X
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = tx2;		xnt[i++] = ty0;
		...
		public static int BuildZertzCup (float w, float t, float h, float h1, float hp, float ballRadius, out float ballHeight, out int bufferN) {
			...
			xnt[i++] = w;		xnt[i++] = hp2;		xnt[i++] = -w;//X'0
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = -w;		xnt[i++] = hp2;		xnt[i++] = -w;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = -w;		xnt[i++] = he;		xnt[i++] = -w;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = 1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			...
			xnt[i++] = -w-t;	xnt[i++] = hp2;		xnt[i++] = -w-t;//X'1
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = w+t;		xnt[i++] = hp2;		xnt[i++] = -w-t;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = w+t;		xnt[i++] = he;		xnt[i++] = -w-t;//X
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;	xnt[i++] = -1.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			...
			xnt[i++] = -w;		xnt[i++] = hp;		xnt[i++] = -w-t;//X'2
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = -w;		xnt[i++] = hp;		xnt[i++] = -w;//X
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = -w;		xnt[i++] = h1;		xnt[i++] = -w;//X
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = -w;		xnt[i++] = h1;		xnt[i++] = -w-t;//X
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			
			xnt[i++] = w;		xnt[i++] = hp;		xnt[i++] = -w;//X'3
			xnt[i++] = -1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = w;		xnt[i++] = hp;		xnt[i++] = -w-t;//X
			xnt[i++] = -1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			...
			xnt[i++] = w;		xnt[i++] = hp;		xnt[i++] = -w;//X'4
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = w+t;		xnt[i++] = hp;		xnt[i++] = -w;//X
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = w+t;		xnt[i++] = hp;		xnt[i++] = -w-t;//X
			xnt[i++] = 0.0f;	xnt[i++] = 1.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			...
			xnt[i++] = -w-t;	xnt[i++] = h1;		xnt[i++] = -w-t;//X'5
			xnt[i++] = -1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = -w-t;	xnt[i++] = h1;		xnt[i++] = -w;//X
			xnt[i++] = -1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			...
			xnt[i++] = w+t;		xnt[i++] = h1;		xnt[i++] = -w;//X'6
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = w+t;		xnt[i++] = h1;		xnt[i++] = -w-t;//X
			xnt[i++] = 1.0f;	xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			...
			xnt[i++] = w;		xnt[i++] = hp2;		xnt[i++] = -w;//X'7
			xnt[i++] = 0.0f;	xnt[i++] = nry;		xnt[i++] = -nrx;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			
			xnt[i++] = w;		xnt[i++] = h1;		xnt[i++] = -w-0.5f*t;//X
			xnt[i++] = 0.0f;	xnt[i++] = nry;		xnt[i++] = -nrx;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
			...
			xnt[i++] = -w;		xnt[i++] = hp2;		xnt[i++] = -w-t;//X'8
			xnt[i++] = 0.0f;	xnt[i++] = nry;		xnt[i++] = nrx;//N
			xnt[i++] = 0.0f;	xnt[i++] = 0.0f;//T
		...
		public static int GenerateCilinder (float height, float r, int segments, out int bufferN) {
			...
			for(int j = 0x00, i = 0x00; j <= segments; j++) {
				sina = (float) Math.Sin(alpha);	sinar = r*sina;
				cosa = (float) Math.Cos(alpha);	cosar = r*cosa;
				
				xnt[i++] = sinar;	xnt[i++] = h_2;		xnt[i++] = cosar;//X
				xnt[i++] = sina;	xnt[i++] = 0.0f;	xnt[i++] = cosa;//N
				xnt[i++] = t;		xnt[i++] = 1.0f;//T
				
				xnt[i++] = sinar;	xnt[i++] = -h_2;	xnt[i++] = cosar;//X
				xnt[i++] = sina;	xnt[i++] = 0.0f;	xnt[i++] = cosa;//N
				xnt[i++] = t;		xnt[i++] = 0.0f;//T
		...
		public static int BuildRing (float height, float r, float R, int segments, out int bufferN) {
			...
			for(int i = 0x00; i <= segments; i++) {
				...
				//r Top
				xnt[j0++] = r*cos;		xnt[j0++] = -h2;		xnt[j0++] = r*sin;//X
				xnt[j0++] = 0.0f;		xnt[j0++] = -1.0f;		xnt[j0++] = 0.0f;//N
				xnt[j0++] = 0.0f;		xnt[j0++] = ty;//T
				
				//R Top
				xnt[j0++] = R*cos;		xnt[j0++] = -h2;		xnt[j0++] = R*sin;//X
				xnt[j0++] = 0.0f;		xnt[j0++] = -1.0f;		xnt[j0++] = 0.0f;//N
				xnt[j0++] = tx1;			xnt[j0++] = ty;//T
				
				//T Rig
				xnt[j1++] = R*cos;		xnt[j1++] = -h2;		xnt[j1++] = R*sin;//X
				xnt[j1++] = cos;		xnt[j1++] = 0.0f;		xnt[j1++] = sin;//N
				xnt[j1++] = tx1;		xnt[j1++] = ty;//T
				
				//B Rig
				xnt[j1++] = R*cos;		xnt[j1++] = h2;			xnt[j1++] = R*sin;//X
				xnt[j1++] = cos;		xnt[j1++] = 0.0f;		xnt[j1++] = sin;//N
				xnt[j1++] = 0.5f;		xnt[j1++] = ty;//T
				
				//R Bot
				xnt[j2++] = R*cos;		xnt[j2++] = h2;			xnt[j2++] = R*sin;//X
				xnt[j2++] = 0.0f;		xnt[j2++] = 1.0f;		xnt[j2++] = 0.0f;//N
				xnt[j2++] = 0.5f;		xnt[j2++] = ty;//T
				
				//r Bot
				xnt[j2++] = r*cos;		xnt[j2++] = h2;			xnt[j2++] = r*sin;//X
				xnt[j2++] = 0.0f;		xnt[j2++] = 1.0f;		xnt[j2++] = 0.0f;//N
				xnt[j2++] = 0.5f+tx1;	xnt[j2++] = ty;//T
				
				//B Lef
				xnt[j3++] = r*cos;		xnt[j3++] = h2;			xnt[j3++] = r*sin;//X
				xnt[j3++] = -cos;		xnt[j3++] = 0.0f;		xnt[j3++] = -sin;//N
				xnt[j3++] = 0.5f+tx1;	xnt[j3++] = ty;//T
				//T Lef
				xnt[j3++] = r*cos;		xnt[j3++] = -h2;		xnt[j3++] = r*sin;//X
				xnt[j3++] = -cos;		xnt[j3++] = 0.0f;		xnt[j3++] = -sin;//N
				xnt[j3++] = 1.0f;		xnt[j3++] = ty;//T
			}
		...
		private static unsafe void subdivide (float* pointer, double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3, int depth, float ra) {
			if(depth > 0x00) {
				...
				*pointer = (float) (ra*x1); pointer++;		*pointer = (float) (ra*y1); pointer++;		*pointer = (float) (ra*z1); pointer++;	//X
				*pointer = (float) x1; pointer++;			*pointer = (float) y1; pointer++;			*pointer = (float) z1; pointer++;		//N
				*pointer = txo; pointer++;					*pointer = ty; pointer++;															//T
				...
				*pointer = (float) (ra*x2); pointer++;		*pointer = (float) (ra*y2); pointer++;		*pointer = (float) (ra*z2); pointer++;	//X
				*pointer = (float) x2; pointer++;			*pointer = (float) y2; pointer++;			*pointer = (float) z2; pointer++;		//N
				*pointer = tx; pointer++;					*pointer = ty; pointer++;															//T
				...
				*pointer = (float) (ra*x3); pointer++;		*pointer = (float) (ra*y3); pointer++;		*pointer = (float) (ra*z3); pointer++;	//X
				*pointer = (float) x3; pointer++;			*pointer = (float) y3; pointer++;			*pointer = (float) z3; pointer++;		//N
				*pointer = tx; pointer++;					*pointer = ty; pointer++;															//T
			}
		}
